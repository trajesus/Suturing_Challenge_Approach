...
Suturing_Challenge_Approach is a comprehensive developer toolkit designed for the development and evaluation of surgical automation and medical imaging models. Key features:

- 🦄🚀 **Rapid Deployment:** Pre-trained models (InceptionV3, ResNet50, YOLO, U-Net) for fast setup in computer vision tasks.
- 🎯 **Automated Evaluation:** Scripts for performance assessment, data processing, and efficient model benchmarking.
- 🔧🔬 **Modular Data Pipelines:** Flexible pipelines for video and image analysis workflows.
...
```
git clone https://github.com/trajesus/Suturing_Challenge_Approach
```

2. **Navigate to the project directory:**
```
cd Suturing_Challenge_Approach/<year>
```
3. **Install dependencies:**
```
pip install -r OSS_25/Task1/requirements.txt OSS_25/Task2/requirements.txt
```
